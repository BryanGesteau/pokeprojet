...
class PokemonsTable extends Table
{
    ...
    public function formatDataForSave($pokeApiData)
    {
        ...
        return [
            ...
            'default_back_sprite_url' => $pokeApiData['sprites']['back_default'] ? $pokeApiData['sprites']['back_default'] : null,
            'shiny_front_sprite_url' => $pokeApiData['sprites']['front_shiny'] ? $pokeApiData['sprites']['front_shiny'] : null,
